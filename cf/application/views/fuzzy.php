            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart('index.php/fuzzy/proses', array('enctype' => 'multipart/form-data','class' => 'form_advanced_validation', 'autocomplete' => 'off' ,'id'=>'form')); ?>
                                <label>BERAPA JUMLAH PENGHASILAN ANDA (Juta)</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="gaji" name="gaji" class="form-control" placeholder="Hai, Kamu Lagi Apa?">
                                    </div>
                                </div>
                                <label>BERAPA JUMLAH ASSET ANDA (Biji)</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="asset" name="asset" class="form-control" placeholder="Hai">
                                    </div>
                                </div>
